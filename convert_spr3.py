...
if __name__ == '__main__':
    ...
    for i in range(Separate_size, Separate_size * 2):
        addr_middle.append(addr[i])

    for i in range(Separate_size * 2, Addr_size):
